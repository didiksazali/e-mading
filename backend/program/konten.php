                  ...
                  <tbody>
                    ...
                    <input type='hidden' name='id_informasi' value='$s[id_informasi]'>
                     <tr><th scope='row'>Kategori Program</th>            <td><select class='form-control' name='id_kategori'> 
                                                                         ...
                                                                         echo "</select></td></tr>
                    <tr><th scope='row' width='180px'>Judul Mading</th>           <td><input type='text' class='form-control' name='judul' value='$s[judul]'></td></tr>
                    ...
                    <tr><th scope='row'>Ganti File</th>             <td><div style='position:relative;''>
                     ...
                     <input type='hidden' class='form-control' name='id_tampil' value='$s[id_tampil]'>
